...
%(written in python and using the acpc python client to connect to the game server) was necessary. 
and in the case of a probabilistic or intelligent player, required adding additional logic.% to the \texttt{continual}$\_$\texttt{resolving} class.
